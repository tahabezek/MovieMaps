      ...
      <div class="col-12">
        <nav class="main-nav">
          ...
          <ul class="nav">
            ...
            <li><a href="giris_yapma.php">Filmler</a></li>
            <li><a href="giris_yapma.php">Topluluk</a></li>
            <li><a href="giris_yapma.php">Hakkımızda</a></li>
            <li><a href="kayit_olma.php">Kayıt Ol</a></li>
            <li><a href="giris_yapma.php">Giriş Yap</a></li>
          </ul>
  ...
  <div class="create-nft">
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-4">
          <div class="main-button">
            <a href="giris_yapma.php">Önce Giriş Yapınız Ardından <br>Film Önerisinde Bulunmak İçin Tıklayınız.</a>
          </div>
        </div>
        <div class="col-lg-4">
